      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <p className="text-sm">
              Challenge créer par {solution.challengeData.createdBy.lastName}{' '}
              {solution.challengeData.createdBy.firstName} - Niveau du challenge
              : {solution.level}{' '}
            </p>
        ...
        <div className="flex justify-between gap-2 items-center">
          ...
          <button
            onClick={togglePopup}
            className={`${solution.status === 'Valide' || solution.status === 'Refus' ? 'hidden' : 'text-btn_green border-btn_green hover:bg-btn_green hover:text-white '} w-fit h-fit self-end border text-sm  px-4 py-3 rounded-md  transition-colors duration-300 ease-in-out`}
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white rounded-lg p-8">
            <h2 className="text-2xl mb-4">
              Valider le challenge du challenger
            </h2>
            <form
